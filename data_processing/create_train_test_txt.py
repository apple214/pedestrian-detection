...
def get_sample_value(txt_name, category_name):
    label_path = '/Users/beauty/Documents/GitHub/pedestrianDetection/data/kitti/training/label_2/'
...
txt_list_path = glob.glob('../data/kitti/training/label_2/*.txt')
txt_list = []
...
Main_path = '../data/kitti/training/'
train_test_name = ['trainval','train','val','test']
category_name = ['Pedestrian', 'Cyclist']
